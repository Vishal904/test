...
<html>
    ...
    <body>
            <div class="container">
                <H1>Welcome ${name}</H1>
                <a class = "btn btn-danger" href="logout.do"
                    style = "float : right; padding : 2px 2px; margin-bottom: 10px">Logout</a>
                <a class = "btn btn-success" href="profile.do?userid=1"
                    ...
                    <tbody>
                        <c:forEach items="${users}" var="user">
                            <tr>
                                ...
                                <td>${user.email}</td>
                                <td>${user.phone}</td>
                                <td><a class = "btn btn-success" href="profile.do?userid=${user.id}"
                                    style = "padding : 2px 2px; margin-bottom: 10px">Profile</a>
                                </td>
                                <td><a class = "btn btn-success" href="userposts.do?userid=${user.id}"
